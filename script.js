...
const wishlistOffcanvas = document.getElementById('wishlist-offcanvas');
...
if (closeSearchBtn) {
    closeSearchBtn.addEventListener('click', () => {
        closeOffcanvas(searchOffcanvas);
    });
}
...
if (closeWishlistBtn) {
    closeWishlistBtn.addEventListener('click', () => {
        closeOffcanvas(wishlistOffcanvas);
    });
}
...
document.addEventListener('click', (e) => {
    if (e.target.classList.contains('variant-btn')) {
        const variantBtns = e.target.parentElement.querySelectorAll('.variant-btn');
...
document.addEventListener('click', (e) => {
    if (e.target.classList.contains('btn-add-cart')) {
        ...
        const activeVariant = productCard.querySelector('.variant-btn.active').textContent;
